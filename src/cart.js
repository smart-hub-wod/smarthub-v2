        ...
        <div>
            <div className="text-center mb-5 mx-5">
                ...
                <div className="mx-5">
                    ...
                    <Link to="/checkout"><Button bsPrefix="button-sh">Proceed to Checkout</Button></Link>
                </div>
            ...
            {c.map((course) => {
                    return (
                        <Card className="pt-3 mx-5 mb-3">
                            ...
                            <XCircle onClick={props.delete} className="float-end text-shblue mx-3" size={30}/>
                            </div>
                            <div className="row">
                            <Link to={`/course-listing/${course}`}><p className="text-start mx-3">View course info</p> </Link> 
                            </div>
                        </Card>
                    )
            })}
