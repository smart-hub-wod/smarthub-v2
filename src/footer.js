    ...
    return (
        <footer>
            <Container fluid className="is-shblue text-white d-flex row justify-content-center py-3 position-sticky bottom-0 end-0">
                ...
                <p className="iconstext text-light">Animated Icons by <a className="text-white" href="https://lordicon.com">Lordicon.com</a></p>
                <div className="d-flex flex-row justify-content-center">
                    <Nav.Link><Link className="link" to="/terms-and-conditions">Terms and Conditions</Link></Nav.Link>
                    <Nav.Link><Link className="link" to="/privacy-policy">Privacy Policy</Link></Nav.Link>
                </div>
            </Container>
        </footer>
    )
